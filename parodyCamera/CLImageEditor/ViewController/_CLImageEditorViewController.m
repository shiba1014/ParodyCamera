...
- (void)initMenuScrollView
{
    if(self.menuView==nil){
        UIView *menuScroll = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.width, 80)];
...
//    [self.imageView addSubview:testImageVIew];
...
//    CGFloat screenHeight = screenSize.height;
    ...
    graphic.frame = CGRectMake(0, 0, screenHeight, screenWidth);
    graphic.position = CGPointMake(screenHeight/2, screenWidth/2);
    graphic.backgroundColor = [UIColor colorWithRed:0.193 green:0.668 blue:0.615 alpha:1.000].CGColor;
    graphic.opacity = 0.5f;
    [graphic addSublayer:self.saveButton.layer];
     */
    
    //self.saveButton.backgroundColor = [UIColor redColor];
    
    //[self.menuView.layer addSublayer:graphic];
    //TODO: fix masuhara
}
...
- (void)setMenuView
{
    ...
    //UIButton *saveButton = [[UIButton alloc] initWithFrame:CGRectMake(160, 250, 70, 80)];
//    UIButton *saveButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 70, 80)];
//    [saveButton setImage:[UIImage imageNamed:@"btn_arrow"] forState:UIControlStateNormal];
//    [_menuView addSubview:saveButton];
//    [_menuView bringSubviewToFront:saveButton];
