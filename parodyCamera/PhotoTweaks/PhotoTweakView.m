...
- (instancetype)initWithFrame:(CGRect)frame image:(UIImage *)image
{
    if (self = [super init]) {
        ...
        NSLog(@"imageX:%f",image.size.width);
        NSLog(@"imageY:%f",image.size.height);
        NSLog(@"maximumX:%f",self.maximumCanvasSize.width);
        NSLog(@"maximumY:%f",self.maximumCanvasSize.height);
        ...
        _scrollView.center = CGPointMake(CGRectGetWidth(self.frame) / 2, self.centerY + 43);
        ...
        _photoContentView.backgroundColor = [UIColor clearColor]; //tempChange
        ...
        //cropViewの大きさ
        _cropView = [[CropView alloc] initWithFrame:CGRectMake(34, 102, 252, 339)];
        //_cropView = [[CropView alloc] initWithFrame:_scrollView.frame];
        ...
        _slider.center = CGPointMake(CGRectGetWidth(self.bounds) / 2, CGRectGetHeight(self.bounds) - 55);
...
//        _levelLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 40, 30)];
//        _levelLabel.center = CGPointMake(CGRectGetWidth(self.bounds) / 2, CGRectGetHeight(self.bounds) - 100);
...
- (void)sliderValueChanged:(id)sender
{
    ...
    //_levelLabel.text = [NSString stringWithFormat:@"%d", (int)_slider.value];
